...
export class PreferedCategoriesComponent implements OnInit, OnDestroy {
  ...
  //kategóriák, felhasználóhoz tartozó adatok, publikus tartalmak lekérdezése, fordítások beállítása
  ngOnInit(): void {
    forkJoin([
  ...
  //kategória hozzáadása, illetve elvétele a kiválasztott kategóriákból
  ...
  //kiválasztott kategóriák elmentése
  saveCategories() {
